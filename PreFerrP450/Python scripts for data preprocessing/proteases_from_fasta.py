...
path = '/home/friederike/Documents/Databases/TryptorubinProducersGenomes/Not_verified_producers_from_TerP450/'

output_proteases="proteases_tryptorubin_producers_with_not_verified_producers.fasta"
proteases=[]
...
for progenome_file in glob.glob(os.path.join(path, '*.fasta')):
        ...
        for progenome_record in SeqIO.parse(progenome_file, "fasta"):
            if "protease" in progenome_record.description or"Protease" in progenome_record.description or"peptidase" in progenome_record.description or"Peptidase" in progenome_record.description:
