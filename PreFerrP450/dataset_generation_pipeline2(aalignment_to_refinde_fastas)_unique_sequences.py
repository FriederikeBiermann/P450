...
input_alignments="/home/friederike/Documents/Coding/P450/PreFerrP450/neighbouring=4_threshold=20/Alignment/"
...
for cluster in clusterlist:
    ...
    for index_fragment,fragment in enumerate(fragments):
        ...
        list_output.append([])
        list_output_files.append("neighbouring=4_threshold=20/Alignment/whole_dataset_neighbouring_4_threshold_20_deduplicated_"+str(cluster)+ " Alignment_consens_"+fragment+".fasta")
        for record in SeqIO.parse("neighbouring=4_threshold=20/Alignment/whole_dataset_neighbouring_4_threshold_20_deduplicated_"+str(cluster)+ " Alignment"+fragment+".fasta", "fasta"):
